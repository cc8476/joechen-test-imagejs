...
function grey(options = {}) {
  ...
  console.log("this.components11111",this.components);
  ...
  let ptr = 0;
  console.log("method",this.channels,this.components);
  

  for (let i = 0; i < this.data.length; i += this.channels) {
    if (mergeAlpha) {
      let result = (0, _clamp.clamp)(method(this.data[i], this.data[i + 1], this.data[i + 2], this) * this.data[i + this.components] / this.maxValue, this);
